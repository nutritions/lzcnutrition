...
![image-20251107151805017](assets/image-20251107151805017.png)

![image-20251107160934584](assets/image-20251107160934584.png)

#### 数据库连接池

![image-20251107170153295](assets/image-20251107170153295.png)

#### xml映射文件

之前是通过注解生成sql语句，对于太复杂的sql语句不方便，所以使用xml文件进行映射

简单用注解

复杂用xml

![image-20251107185113595](assets/image-20251107185113595.png)

![image-20251107190054191](assets/image-20251107190054191.png)

### springboot配置文件

yml格式，不臃肿，层次更清晰

![image-20251108004747757](assets/image-20251108004747757.png)

### 智能学习辅助系统项目实战

#### 前后端分离

**![image-20251108010736929](assets/image-20251108010736929.png)**

#### RESTful风格软件架构

![image-20251108011435500](assets/image-20251108011435500.png)

#### Apifox

用于前后端分别在各自的开发前段，进行模拟测试

例如测试后端接口，需要模拟前端请求，但浏览器地址栏发出的请求都是GET